...
import { Actividad, Detalleactividad } from 'src/app/@shared/modals/Actividad';
...
@Component({
  selector: 'app-view-idcod',
  templateUrl: './view-idcod.component.html',
  styleUrls: ['./view-idcod.component.css']
})
export class ViewIdcodComponent implements OnInit {
  ...
  filterTerm: string;
   ...
   constructor(   private route: ActivatedRoute,
    ...
    ngOnInit(){
      ...
      Salir(){
        this.router.navigate(["list-idcod"]);
     }
